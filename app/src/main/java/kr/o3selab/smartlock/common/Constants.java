...
public class Constants {
    ...
    public static final String PREFERENCE_KEY_AUTO_CONNECT= "AutoConnect";
    ...
    public static final String PREFERENCE_CONN_INFO_SECRETKEY = "device_secrectkey";
    public static final String PREFERENCE_RESPONSIVENESS = "device_responsiveness";
    public static final String PREFERENCE_KEY_NOTI = "device_noti";
